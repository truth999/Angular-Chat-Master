...
import { AddChat } from '../ngrx/actions/chat.actions';
...
export class ChatService {
            ...
            this.http.post<string>(`${endpoint}/login`, { email: "eve.holt@reqres.in", password: "cityslicka" })
                .subscribe(
                    data => {
                        ...
                        //create incoming chat
                        let callId = Date.now().toString()
                        this.activeRequest = {
                            id: 'Siva-wc1',
                            name: 'Siva',
                            callId: callId, //00001010641547143526
                        ...
                        this.addChatData(callId)

                        //create outgoing chat
                        let callId1 = Date.now().toString() + '123'
                        this.activeRequest = {
                            id: 'Siva-wc1',
                            name: 'Siva',
                            callId: callId1, //00001010641547143526
                            customerId: '12004000009',
                            type: "chat",
                            callType: "INBOUND",
                            callStatus: 'new',
                ...
                .subscribe(
                    data => {
                        ...
                        this.store.select('chats').subscribe(val => {
                            ...
                            currentChat = val[index];
                        })
                        let newChat = { ...currentChat, callId: callId };
                        // console.log(newEmail);
                        this.store.dispatch(new AddChat(newChat))
    ...
    addChatData(callID) {
        this.chat = {
            ...
            "endDate": "2020-10-21T16:39:25.827Z",
            "WrapUpCode": "",
            "WrapUpComment": "",
            "chatTranscript": [
                {
            ...
            "signalingVars": {
                "meta_ucid": "00001010641547143526",
                "call_id": "00001010641547143526",
                "meta_distributing_vdn": "16125090781",
                "meta_mediatype": "CO",
                "meta_customername": "Siva",
                "meta_ani": "12004000009",
                "call_status": "ESTABLISHED",
                "meta_vdnname": "OmniChannel 10",
                "call_sub_type": "NONE",
                "meta_sysid": "0bbe5a90dbfc1850a4e27d7f29961902",
                "src_addr": "12004000009",
                "meta_original_ucid": "00000000000000000000",
                "meta_skill": "12001000001",
                "call_type": "INBOUND",
                "dst_addr": "16125090781",
                "meta_tsapi_call_id": "1065",
                "meta_uui": "T%7CCO%2CID%7C1603521036417035%2CF%7CFBB%2CNM%7CSiva",
                "meta_filtertype": "GHS",
                "meta_conversationid": "Siva-wc1",
                "ev_name": "EV_CALL_STATUS",
                "meta_skill_name": "OmniChannel 10",
                "meta_ani_name": "Monitoring 7",
                "callinitiatedtime__c": "10/21/2020, 10:09:21 PM",
                "callinitiatedtimeiso": "2020-10-21T16:39:21.796Z",
                "callinitiatedtime": 1603298361796,
                "meta_autoassociatequeryval": "0bbe5a90dbfc1850a4e27d7f29961902",
                "subject": "10/21/2020, 10:09:21 PM",
                "status": "Completed",
                "calltype": "",
                "callobject": "00001010641547143526",
                "meta_dnis_name": "OmniChannel 10",
                "auto_in_enabled": "false",
                "meta_dnis": "16125090781",
                "wrapup_enabled": "false",
                "meta_delivering_acd": "12001000001",
                "callansweredtime__c": "10/21/2020, 10:09:26 PM",
                "callansweredtimeiso": "2020-10-21T16:39:26.914Z",
                "callansweredtime": 1603298366914
            },
            "displayData": [
                {
                    "name": "ani",
            ...
            "screenPopDone": true,
            "showCobrowseCriteria": false,
            "isWebChatFilter": false,
            "isVerifiedAfterRefresh": true,
            "blockWordsFound": false,
            "blockWordMessage": "",
            "isActive": true,
            "wrapupInProgress": false,
            "enableManualScreenpop": true,
            "agentCobrowseEnable": false,
        ...
        this.store.dispatch(new AddChat(this.chat))
    }
}
